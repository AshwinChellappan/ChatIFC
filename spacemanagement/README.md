# ChatIFC Studio: Space Management APIs

## Description
Space Management is a FastAPI backend application hosted on Azure App Services. It provides a set of RESTful APIs for managing operations for the spaces.
...
1. Clone the repository:
    ...
    https://IFC-CIT-Org@dev.azure.com/IFC-CIT-Org/IFC-CIT-GenAI-Accelerator/_git/genai-accel-services-spacemgmt
    cd <your_project_path>/genai-accel-services-spacemgmt
    ```
