# ChatIFC Studio: Prompt Studio APIs

## Description
Prompt Studio is a FastAPI backend application hosted on Azure App Services. It provides a set of RESTful APIs for managing operations related to prompts and prompt lists.
...
1. Clone the repository:
    ...
    https://IFC-CIT-Org@dev.azure.com/IFC-CIT-Org/IFC-CIT-GenAI-Accelerator/_git/genai-accel-services-promptstudio
    cd <your_project_path>/genai-accel-services-promptstudio
    ```
